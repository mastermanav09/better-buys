...
import { auth } from "../utils/store/reducers/user";
...
const Login = () => {
  ...
  const submitHandler = ({ email, password }) => {
    dispatch(auth({ email, password, setIsLoading }));
  };
  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow-md dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10 mx-auto my-20">
        <div className="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl dark:text-white">
          Login To Your Account
        </div>
        <div className="h-4 my-1">
          {errors.email ? (
            <div className="text-red-500 text-xs md:text-sm leading-none">
